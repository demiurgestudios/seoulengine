/**
 * \file EditorUICommandDeleteObjects.h
...
#pragma once
#ifndef EDITOR_UI_COMMAND_DELETE_OBJECTS_H
#define EDITOR_UI_COMMAND_DELETE_OBJECTS_H
...
class CommandDeleteObjects SEOUL_SEALED : public DevUI::Command
{
public:
	SEOUL_REFLECTION_POLYMORPHIC(CommandDeleteObjects);

	typedef HashSet<SharedPtr<Scene::Object>, MemoryBudgets::Editor> Objects;

	CommandDeleteObjects(
