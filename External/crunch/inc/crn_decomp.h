...
#if __ANDROID_API__ < 17 /* EXT_DEMIURGE: */
extern "C" { size_t malloc_usable_size(void* ptr) { CRND_ASSERT(0); return 0; } } /* EXT_DEMIURGE: */
#endif /* EXT_DEMIURGE: */
#elif defined(__APPLE__) || defined(__linux__) /* EXT_DEMIURGE: */
extern "C" { size_t malloc_usable_size(void* ptr) { CRND_ASSERT(0); return 0; } } /* EXT_DEMIURGE: */
#endif /* EXT_DEMIURGE: */
