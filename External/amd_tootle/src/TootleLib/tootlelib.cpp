...
#ifdef _DISABLE_EXCEPTIONS // EXT_DEMIURGE:
#define AMD_TOOTLE_API_FUNCTION_BEGIN // EXT_DEMIURGE:
#define AMD_TOOTLE_API_FUNCTION_END // EXT_DEMIURGE:
#define AMD_TOOTLE_API_FUNCTION_NULL_END // EXT_DEMIURGE:
#else // EXT_DEMIURGE:
...
#define AMD_TOOTLE_API_FUNCTION_NULL_END\
    }                                   \
    catch (...)                         \
    {                                   \
        return;                         \
...
void TOOTLE_DLL TootleCleanup()
{
    // EXT_DEMIURGE: try
    // EXT_DEMIURGE: {
    AMD_TOOTLE_API_FUNCTION_BEGIN // EXT_DEMIURGE:
	...
	AMD_TOOTLE_API_FUNCTION_NULL_END // EXT_DEMIURGE:
    // EXT_DEMIURGE: }
    // EXT_DEMIURGE: catch (...)
    // EXT_DEMIURGE: {
    // EXT_DEMIURGE: }
