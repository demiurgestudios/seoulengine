...
public:
	...
	// True if this body has at least one sensor.
...
inline void b3Body::SetTransform(const b3Vec3& position, const b3Quat& orientation)
{
	...
	m_xf.rotation = b3QuatMat33(orientation);
...
// True if this body has at least one sensor.
inline bool b3Body::HasSensor() const
{
	return (e_hasSensor == (e_hasSensor & m_flags));
}
