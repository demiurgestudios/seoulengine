...
#if !defined(_MSC_VER) && !defined(__clang__) /* EXT_DEMIURGE: */
...
#  define je_malloc_conf seoul_je_malloc_conf
#  define je_malloc_message seoul_je_malloc_message
#  define je_malloc seoul_je_malloc
#  define je_calloc seoul_je_calloc
#  define je_posix_memalign seoul_je_posix_memalign
#  define je_aligned_alloc seoul_je_aligned_alloc
#  define je_realloc seoul_je_realloc
#  define je_free seoul_je_free
#  define je_mallocx seoul_je_mallocx
#  define je_rallocx seoul_je_rallocx
#  define je_xallocx seoul_je_xallocx
#  define je_sallocx seoul_je_sallocx
#  define je_dallocx seoul_je_dallocx
#  define je_sdallocx seoul_je_sdallocx
#  define je_nallocx seoul_je_nallocx
#  define je_mallctl seoul_je_mallctl
#  define je_mallctlnametomib seoul_je_mallctlnametomib
#  define je_mallctlbymib seoul_je_mallctlbymib
#  define je_malloc_stats_print seoul_je_malloc_stats_print
#  define je_malloc_usable_size seoul_je_malloc_usable_size
#  ifndef _MSC_VER /* EXT_DEMIURGE: */
#    define je_memalign seoul_je_memalign
#    define je_valloc seoul_je_valloc
#  endif /* EXT_DEMIURGE: */
#endif

#include <stdlib.h>
#include <limits.h> /* EXT_DEMIURGE: */
#include <stdbool.h>
#include <stdint.h>
#ifndef _MSC_VER /* EXT_DEMIURGE: */
#include <strings.h>
#else /* EXT_DEMIURGE: */
#include <msvc_compat/strings.h> /* EXT_DEMIURGE: */
#endif /* EXT_DEMIURGE: */
