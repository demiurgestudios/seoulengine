...
bool	opt_redzone = 
#if (defined(JEMALLOC_DEBUG) && defined(JEMALLOC_FILL)) /* EXT_DEMIURGE: */
    true /* EXT_DEMIURGE: */
#else /* EXT_DEMIURGE: */
	false
#endif /* EXT_DEMIURGE: */
...
static volatile long has_init_init_lock = 0; /* EXT_DEMIURGE: */
...
_init_init_lock(void)
{
	...
	while (1 != has_init_init_lock) { /* EXT_DEMIURGE: */
		if (0 == InterlockedCompareExchange(&has_init_init_lock, (long)-1, (long)0)) { /* EXT_DEMIURGE: */
			malloc_mutex_init(&init_lock, "init", WITNESS_RANK_INIT);
			has_init_init_lock = 1; /* EXT_DEMIURGE: */
		} /* EXT_DEMIURGE: */
	} /* EXT_DEMIURGE: */
}
...
#if defined(__ANDROID__) /* EXT_DEMIURGE: */
	/* Android only supports compiled options. */ /* EXT_DEMIURGE: */
	for (i = 1; i < 2; i++) { /* EXT_DEMIURGE: */
#else /* EXT_DEMIURGE: */
	for (i = 0; i < 4; i++) {
#endif /* EXT_DEMIURGE: */
...
#if (defined(JEMALLOC_HAVE_PTHREAD_ATFORK) && !defined(JEMALLOC_MUTEX_INIT_CB) /* EXT_DEMIURGE: */ \
    && !defined(JEMALLOC_ZONE) && !defined(_WIN32) && /* EXT_DEMIURGE: */ \
    !defined(__native_client__)) /* EXT_DEMIURGE: */
int pthread_atfork(void (*prepare)(void), void (*parent)(void), void(*child)(void)); /* EXT_DEMIURGE: */
#endif /* EXT_DEMIURGE: */
...
malloc_init_hard_finish(tsdn_t *tsdn)
{
...
#if defined(ANDROID_MAX_ARENAS) /* EXT_DEMIURGE: */
	 ...
	 */
	if (opt_narenas > ANDROID_MAX_ARENAS) /* EXT_DEMIURGE: */
		opt_narenas = ANDROID_MAX_ARENAS; /* EXT_DEMIURGE: */
#endif /* EXT_DEMIURGE: */
