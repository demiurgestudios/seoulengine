...
#	include <android/log.h> /* EXT_DEMIURGE: */
#endif /* EXT_DEMIURGE: */
...
{
#ifdef _WIN32 /* EXT_DEMIURGE: */
	OutputDebugStringA(s); /* EXT_DEMIURGE: */
#elif defined(__ANDROID__) /* EXT_DEMIURGE: */
	__android_log_write(ANDROID_LOG_ERROR, "jemalloc", s); /* EXT_DEMIURGE: */
#else /* EXT_DEMIURGE: */
