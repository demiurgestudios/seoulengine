...
typedef struct /* EXT_DEMIURGE: */mz_zip_archive_file_stat/* EXT_DEMIURGE: */
{
...
typedef enum {
    ...
    MZ_ZIP_FLAG_ACCEPT_RECOVERABLE_CORRUPTION = 0x20000 /* EXT_DEMIURGE: For .fla compatibility - accept certain corrupted fields in the central directory. */
} mz_zip_flags;
...
typedef struct /* EXT_DEMIURGE: */mz_zip_archive/* EXT_DEMIURGE: */
{
