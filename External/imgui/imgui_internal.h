...
enum ImGuiNextWindowDataFlags_
{
    ...
    ImGuiNextWindowDataFlags_BringToDisplayBack = 1 << 11, // EXT_DEMIURGE:
};
...
struct ImGuiContext
{
    ...
    bool                    AcceleratedThisFrame; // EXT_DEMIURGE:
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        AcceleratedThisFrame = false; // EXT_DEMIURGE:
    }
};
...
struct IMGUI_API ImGuiWindow
{
    ...
    signed char             ResizeBorderHovered;                // EXT_DEMIURGE:
...
//#endif
    ...
    IMGUI_API void          RenderText(ImVec2 pos, const char* text, const char* text_end = NULL, bool hide_text_after_hash = true/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator = ImGuiTextMarkupMode_None /* EXT_DEMIURGE: */);
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width);
    IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator = ImGuiTextMarkupMode_None /* EXT_DEMIURGE: */);
    IMGUI_API void          RenderTextClippedEx(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator = ImGuiTextMarkupMode_None /* EXT_DEMIURGE: */);
    ...
    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0/* EXT_DEMIURGE: */, bool with_id = false /* EXT_DEMIURGE: */);
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0/* EXT_DEMIURGE: */, bool indeterminate = false /* EXT_DEMIURGE: */);
    IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos);
    IMGUI_API bool          CollapseButton(ImGuiID id, const ImVec2& pos, ImGuiDockNode* dock_node);
    IMGUI_API bool          ArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API void          Scrollbar(ImGuiAxis axis);
    IMGUI_API bool          ScrollbarEx(const ImRect& bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 avail_v, ImS64 contents_v, ImDrawFlags flags);
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col/* EXT_DEMIURGE: */, bool enabled = true/* EXT_DEMIURGE: */);
    ...
    template<typename T>                                        IMGUI_API bool  CheckboxFlagsT(const char* label, T* flags, T flags_value/* EXT_DEMIURGE: */, bool enabled = true, unsigned int indeterminate = 0/* EXT_DEMIURGE: */);
    ...
    // InputText
    // EXT_DEMIURGE: IMGUI_API bool          InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
