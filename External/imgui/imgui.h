...
typedef int ImGuiTextMarkupMode;    // EXT_DEMIURGE:
...
// EXT_DEMIURGE:
enum ImGuiTextMarkupMode_
{
    ImGuiTextMarkupMode_None,
...
namespace ImGui
{
    ...
    // Widgets: Text
    IMGUI_API void          TextUnformatted(const char* text, const char* text_end = NULL/* EXT_DEMIURGE: */, bool with_id = false /* EXT_DEMIURGE: */); // raw text without formatting. Roughly equivalent to Text("%s", text) but: A) doesn't require null terminated string if 'text_end' is specified, B) it's faster, no memory copy is done, no buffer size limits, recommended for long chunks of text.
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0) /* EXT_DEMIURGE: */, bool enabled = true, bool indeterminate = false /* EXT_DEMIURGE: */);   // button
    ...
    IMGUI_API bool          ImageButton(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0),  const ImVec2& uv1 = ImVec2(1,1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0,0,0,0), const ImVec4& tint_col = ImVec4(1,1,1,1) /* EXT_DEMIURGE: */, bool enabled = true /* EXT_DEMIURGE: */);    // <0 frame_padding uses default frame padding settings. 0 for no padding
    IMGUI_API bool          Checkbox(const char* label, bool* v/* EXT_DEMIURGE: */, bool enabled = true, bool indeterminate = false /* EXT_DEMIURGE: */);
    IMGUI_API bool          CheckboxFlags(const char* label, int* flags, int flags_value/* EXT_DEMIURGE: */, bool enabled = true, unsigned int indeterminate = 0 /* EXT_DEMIURGE: */);
    IMGUI_API bool          CheckboxFlags(const char* label, unsigned int* flags, unsigned int flags_value/* EXT_DEMIURGE: */, bool enabled = true, unsigned int indeterminate = 0 /* EXT_DEMIURGE: */);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0/* EXT_DEMIURGE: */, bool enabled = true, bool indeterminate = false /* EXT_DEMIURGE: */);
    IMGUI_API void          EndCombo(); // only call EndCombo() if BeginCombo() returns true!
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* const items[], int items_count, int popup_max_height_in_items = -1/* EXT_DEMIURGE: */, bool enabled = true, bool indeterminate = false /* EXT_DEMIURGE: */);
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items = -1/* EXT_DEMIURGE: */, bool enabled = true, bool indeterminate = false /* EXT_DEMIURGE: */);      // Separate items with \0 within a string, end item-list with \0\0. e.g. "One\0Two\0Three\0"
    IMGUI_API bool          Combo(const char* label, int* current_item, bool(*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int popup_max_height_in_items = -1/* EXT_DEMIURGE: */, bool enabled = true, bool indeterminate = false /* EXT_DEMIURGE: */);
    ...
    IMGUI_API bool          DragFloat(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0/* EXT_DEMIURGE: */, ImGuiInputTextFlags extra_flags = 0 /* EXT_DEMIURGE: */);     // If v_min >= v_max we have no bound
    ...
    IMGUI_API bool          DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0/* EXT_DEMIURGE: */, ImGuiInputTextFlags extra_flags = 0 /* EXT_DEMIURGE: */);
    ...
    IMGUI_API bool          InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL); // EXT_DEMIURGE:
    ...
    // Text Utilities
    IMGUI_API ImVec2        CalcTextSize(const char* text, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator = ImGuiTextMarkupMode_None /* EXT_DEMIURGE: */);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_NoCloseButton          = 1 << 22,  // EXT_DEMIURGE:
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_SetFocus            = 1 << 22,  // EXT_DEMIURGE: Text box will gain focus.
    ImGuiInputTextFlags_Indeterminate       = 1 << 23,  // EXT_DEMIURGE: Text box is handling multiple disparate values, should display the indeterminate value.
...
struct ImGuiStyle
{
    ...
    float       TreeNodeRounding;           // EXT_DEMIURGE:
...
typedef void (*ImDrawCallback)(const ImDrawList* parent_list, const ImDrawCmd* cmd/* EXT_DEMIURGE: */, void* context /* EXT_DEMIURGE: */);
#endif
...
struct ImDrawCmd
{
    ...
    ImVec2          TexScreenDim;       // EXT_DEMIURGE: When applicable, the dimensions of the largest texture of this draw command.
...
struct ImDrawCmdHeader
{
    ...
    ImVec2          TexScreenDim; // EXT_DEMIURGE:
};
...
struct ImDrawList
{
    ...
    ImVector<ImVec2>        _TextureDimStack;   // EXT_DEMIURGE: [Internal]
    ...
    IMGUI_API void  PopClipRect();
    IMGUI_API void  PushTextureID(ImTextureID texture_id/* EXT_DEMIURGE: */, const ImVec2& texScreenDim = ImVec2(0, 0) /* EXT_DEMIURGE: */);
    ...
    IMGUI_API void  AddText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator = ImGuiTextMarkupMode_None /* EXT_DEMIURGE: */);
    IMGUI_API void  AddText(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL /* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator = ImGuiTextMarkupMode_None /* EXT_DEMIURGE: */);
...
struct ImFont
{
    ...
    IMGUI_API ImVec2            CalcTextSizeA(float size, float max_width, float wrap_width/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator /* EXT_DEMIURGE: */, const char* text_begin, const char* text_end = NULL, const char** remaining = NULL) const; // utf8
    IMGUI_API const char*       CalcWordWrapPositionA(float scale/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator /* EXT_DEMIURGE: */, const char* text, const char* text_end, float wrap_width) const;
    IMGUI_API void              RenderChar(ImDrawList* draw_list, float size, const ImVec2& pos, ImU32 col, ImWchar c) const;
    IMGUI_API void              RenderText(ImDrawList* draw_list, float size, const ImVec2& pos, ImU32 col, const ImVec4& clip_rect/* EXT_DEMIURGE: */, ImGuiTextMarkupMode ampersand_as_accelerator /* EXT_DEMIURGE: */, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false) const;
