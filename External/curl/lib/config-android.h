...
/*
 * EXT_DEMIURGE: There are a lot of certificates here (199 files, 1.3 MB on my
 * device), so I think it's best not to load them by default
 */
...
/*EXT_DEMIURGE: #define HAVE_GETADDRINFO 1*/

/* Define to 1 if the getaddrinfo function is threadsafe. */
/*EXT_DEMIURGE: #define HAVE_GETADDRINFO_THREADSAFE 1*/
...
/* Define to 1 if you do not have the <openssl/engine.h> header file. */
#define OPENSSL_NO_ENGINE 1 /* EXT_DEMIURGE: */
...
#define HAVE_PTHREAD_H 1 /* EXT_DEMIURGE: */
...
#define USE_THREADS_POSIX 1 /* EXT_DEMIURGE: */
