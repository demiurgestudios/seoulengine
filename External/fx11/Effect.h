...
#if 0 // EXT_DEMIURGE: Moved to pchfx.h
#ifdef _DEBUG
...
protected:
	...
	ID3DX11EffectTechnique  *m_pActiveTechnique; // EXT_DEMIURGE:
...
public:
	...
	// EXT_DEMIURGE:
	STDMETHOD_(ID3DX11EffectTechnique*, GetActiveEffectTechnique)() { return m_pActiveTechnique; }
	STDMETHOD_(void, SetActiveEffectTechnique)(ID3DX11EffectTechnique* pTechnique) { m_pActiveTechnique = pTechnique; }
	// /EXT_DEMIURGE:
