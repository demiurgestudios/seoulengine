...
protected:
    ...
    {
        HRESULT hr = S_OK;
        LPSTR pSemantic = 0; // EXT_DEMIURGE:
        ...
        /* EXT_DEMIURGE: LPSTR */pSemantic = m_SemanticString[Stream];
...
lExit:
    ...
    HRESULT ConsumeOutputSlot( _Inout_z_ LPSTR* ppSemantic )
    {
        ...
        *pColon = '\0';
        /* EXT_DEMIURGE: int */outputSlot = atoi(*ppSemantic);
