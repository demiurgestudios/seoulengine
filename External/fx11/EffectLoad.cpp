...
HRESULT CEffectLoader::LoadEffect(CEffect *pEffect, const void *pEffectBuffer, uint32_t cbEffectBuffer)
{
    ...
    uint32_t oStructured = 0; // EXT_DEMIURGE:
    ...
    /* EXT_DEMIURGE: uint32_t */oStructured = m_pHeader->cbUnstructured + sizeof(SBinaryHeader5);
...
HRESULT CEffectLoader::LoadTypeAndAddToPool(SType **ppType, uint32_t  dwOffset)
{
    ...
    uint32_t  cElements = 0; // EXT_DEMIURGE:
    ...
    /* EXT_DEMIURGE: uint32_t  */cElements = std::max<uint32_t>(1, temporaryType.Elements);
...
HRESULT CEffectLoader::GrabShaderData(SShaderBlock *pShaderBlock)
{
    ...
    uint32_t NumInterfaces = 0; // EXT_DEMIURGE:
    uint32_t CurInterfaceParameter = 0; // EXT_DEMIURGE:
    ...
    /* EXT_DEMIURGE: uint32_t */NumInterfaces = pShaderBlock->pReflectionData->pReflection->GetNumInterfaceSlots();
    /* EXT_DEMIURGE: uint32_t */CurInterfaceParameter = 0;
    if( NumInterfaces > 0 )
    {
