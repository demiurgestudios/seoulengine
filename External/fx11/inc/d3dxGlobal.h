...
{
    using CEffectVector<T*>::m_pData; // EXT_DEMIURGE:
    using CEffectVector<T*>::m_MaxSize; // EXT_DEMIURGE:
    using CEffectVector<T*>::m_CurSize; // EXT_DEMIURGE:
public:
    using CEffectVector<T*>::m_hLastError; // EXT_DEMIURGE:
...
{
    typedef CEffectHashTable<T, pfnIsEqual> Super;
    using Super::CleanArray; // EXT_DEMIURGE:
    using Super::m_NumHashSlots; // EXT_DEMIURGE:
    using Super::m_NumEntries; // EXT_DEMIURGE:
    using Super::SHashEntry; // EXT_DEMIURGE:
    using Super::m_rgpHashEntries; // EXT_DEMIURGE:
protected:
