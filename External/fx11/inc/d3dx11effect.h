...
DECLARE_INTERFACE_(ID3DX11Effect, IUnknown)
{
	...
	// EXT_DEMIURGE:
	STDMETHOD_(ID3DX11EffectTechnique*, GetActiveEffectTechnique)(THIS) PURE;
	STDMETHOD_(void, SetActiveEffectTechnique)(THIS_ ID3DX11EffectTechnique* pTechnique) PURE;
	// /EXT_DEMIURGE:
};
