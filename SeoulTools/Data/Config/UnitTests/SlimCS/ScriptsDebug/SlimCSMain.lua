...
final_class('float', nil, nil, 'Single')
...
final_class('sbyte', nil, nil, 'SByte')
_G.sbyte.__default_value = 0
final_class('short', nil, nil, 'Int16')
_G.short.__default_value = 0
final_class('int', nil, nil, 'Int32')
_G.int.__default_value = 0
final_class('long', nil, nil, 'Int64')
_G.long.__default_value = 0
final_class('byte', nil, nil, 'Byte')
_G.byte.__default_value = 0
final_class('ushort', nil, nil, 'UShort')
_G.ushort.__default_value = 0
final_class('uint', nil, nil, 'UInt32')
_G.uint.__default_value = 0
final_class('ulong', nil, nil, 'UInt64')
