...
function DisplayObject:OnHotLoadBeginHandler()

	-- Nop
end

function DisplayObject:OnHotLoadEndHandler()

	-- Nop
end

function DisplayObject:RegisterForHotLoadEvents()

	self:GetRootMovieClip():RegisterForHotLoad(self)
end
...
function DisplayObject:GetDebugName()
	...
	return self.m_udNativeInstance:GetDebugName()
