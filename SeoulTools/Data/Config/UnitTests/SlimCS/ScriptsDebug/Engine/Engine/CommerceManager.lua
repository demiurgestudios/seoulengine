...
function CommerceManager.cctor()
	...
	_G.HANDLER_GlobalOnItemInfoRefreshed = function(eResult)
		...
		repeat local _ = eResult; if _ == 0 then goto case elseif _ == 1 then goto case0 elseif _ == 2 then goto case1 else goto case2 end
			...
			::case::
				CoreNative.LogChannel('Commerce'--[[LoggerChannel.Commerce]], 'Refreshed IAP item info, inform UIs')
				UIManager.BroadcastEvent 'HANDLER_OnItemInfoRefreshed'
				break

			::case0::
				CoreNative.LogChannel('Commerce'--[[LoggerChannel.Commerce]], 'Failed to refresh IAP item info')
				break

			::case1::
				CoreNative.LogChannel('Commerce'--[[LoggerChannel.Commerce]], 'Refresh of IAP item info found no products')
				break

			::case2::
				CoreNative.LogChannel(
					'Commerce'--[[LoggerChannel.Commerce]],
